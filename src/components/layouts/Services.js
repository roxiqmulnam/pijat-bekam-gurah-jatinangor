...
const Services = () => {
  return (
    <div className="w-full py-20 text-white bg-slate-800">
      <h1 className="text-center font-bold py-8 text-2xl lg:text-4xl ">
        Menu kami
      </h1>
      <div className="wrapper-components grid md:grid-cols-3 gap-8">
        <div className="w-full border border-slate-900 border-t-4 border-t-green-500 shadow-2xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          <h2 className="text-2xl font-bold text-center py-8">PIJAT</h2>
          <p className="text-center text-3xl font-bold">Rp.150.000,-</p>
          ...
          <Link
            ...
            className="mx-auto"
          >
            <button className="bg-green-500 text-white rounded-lg font-medium text-lg w-48 h-12 my-6 mx-auto md:w-44">
              Hubungi Kami
            </button>
          </Link>{' '}
        </div>
